...
//             Enrolled Courses
//           </p>
//           <div className="bg-white shadow-md rounded-lg p-4 sm:p-6 flex flex-col sm:flex-row items-center gap-4 h-full">
//             <img
//               src={Rectangle4317}
//               alt="Course"
//               className="w-28 sm:w-40 h-16 sm:h-24 object-cover rounded-md flex-shrink-0"
//             />
//             <div className="flex-1 flex flex-col gap-2 w-full">
//               <p className="font-semibold text-gray-800 text-sm sm:text-base text-center sm:text-left">
...
//               <button className="mt-3 bg-[#15256E] text-white px-4 py-2 rounded-md hover:bg-[#0f1f5a] transition-colors self-center sm:self-start">
//                 Continue Learning
//               </button>
//             </div>
//           </div>
...
//             Progress Overview
//           </p>
//           <div className="bg-white shadow-md rounded-lg p-4 sm:p-6 flex flex-col sm:flex-row gap-6 h-full">

//             {/* Left Section */}
//             <div className="flex-1 flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-2 sm:border-r sm:border-gray-200 pr-0 sm:pr-4 h-full justify-between">
              
//               {/* Image for mobile */}
//               <img
//                 src={Rectangle4317}
//                 alt="Course"
//                 className="w-28 sm:w-20 h-16 sm:h-24 object-cover rounded-md flex-shrink-0 sm:hidden"
//               />
...
//             <div className="flex-1 flex flex-col items-center sm:items-start gap-2 mt-4 sm:mt-0 h-full justify-center">
//               <p className="font-semibold text-gray-800 text-sm sm:text-base text-center sm:text-left">
...
//   return (
//     <div className="p-4 sm:p-6 space-y-20 sm:spacey-6">
...
//           <p className="font-semibold text-gray-800 text-base md:text-lg sm:mb-2">
//             Progress Overview
//           </p>

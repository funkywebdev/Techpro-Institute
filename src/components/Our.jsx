        ...
        {courses.map((course) => (
          ...
          >
            ...
            <motion.button
              whileTap={{ scale: 0.96 }}
              onClick={() => navigate(`/course/${course.slug}`)}
              className="mt-auto w-full py-2 sm:py-2.5 rounded-lg border border-blue-800 text-blue-800 font-semibold text-xs sm:text-sm hover:bg-blue-800 hover:text-white transition-colors duration-300"
            >
              View Course
            </motion.button>
          </motion.div>

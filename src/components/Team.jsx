...
//   return (
//     <section className="relative px-6 py-6 sm:py-12 font-poppins bg-gradient-to-tr from-fuchsia-50 via-purple-50 to-indigo-50">
//       {/* Heading */}
//       <div className="max-w-2xl mx-auto mb-20 text-center">
//         <h2 className="text-[17px] font-bold text-black sm:text-3xl">
...
//               className="relative mx-auto w-full cursor-pointer [perspective:1200px] aspect-square"
//             >
//               <div
...
//                 {/* FRONT */}
//                 <div
//                   className="absolute inset-0 flex flex-col justify-between overflow-hidden rounded-md"
...
//                   />
//                   {!isFlipped && (
//                     <span className="absolute px-3 py-1 text-xs text-black rounded-full top-4 right-4 bg-white/70 lg:hidden">
//                       Tap to read bio
//                     </span>
//                   )}
//                   <div className="absolute bottom-0 w-full p-2 text-center bg-black/30 rounded-b-md backdrop-blur-sm">
...
//                 {/* BACK */}
//                 <div
//                   className="absolute inset-0 flex flex-col justify-center p-6 text-center text-white rounded-md bg-black/70 backdrop-blur-sm"
//                   style={{
//                     transform: "rotateY(180deg)",
//                     backfaceVisibility: "hidden",
//                   }}
//                 >
//                   <h3 className="mb-3 text-lg font-semibold">{member.name}</h3>
//                   <p className="mb-4 text-sm text-gray-200">{member.role}</p>
//                   <div className="overflow-y-auto text-sm leading-relaxed max-h-[60%]">
//                     {member.bio}
//                   </div>
//                   <span className="mt-4 text-xs text-gray-300 lg:hidden">
//                     Tap to go back
//                   </span>
//                 </div>
//               </div>

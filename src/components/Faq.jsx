...
//           <button className="mt-4 inline-flex items-center justify-center px-6 py-3 rounded-xl bg-[#F1F1F3] text-[#262626] text-sm font-medium hover:bg-gray-200 transition w-fit">
//             See All FAQs
//           </button>
//         </div>
...
//             <div
//               key={index}
//               className="flex items-center justify-between p-4 rounded-xl border border-gray-200 hover:shadow-sm transition cursor-pointer"
//             >
...
//           <button className="mt-4 px-6 py-3 rounded-xl bg-[#F1F1F3] text-[#262626] text-sm font-medium hover:bg-gray-200 transition w-fit">
//             See All FAQs
//           </button>
//         </div>

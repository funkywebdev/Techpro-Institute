...
//         <p className="text-gray-600 max-w-lg mx-auto md:mx-0 text-sm sm:text-base md:text-lg leading-relaxed px-4 md:px-0">
//           Gain globally recognized Scrum certifications and become a
//           high-demand Agile professional with practical industry training.
//         </p>
...
//             className="w-full max-w-[370px]  sm:max-w-[600px] drop-shadow-xl"
//             animate={{ y: [0, -8, 0] }}
//             transition={{
//               duration: 3,
//               repeat: Infinity,

    ...
    >
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-8 md:gap-6 relative z-10">
        ...
        >
          ...
          <motion.h1
            variants={item}
            className="font-extrabold text-[18px] sm:text-[30px] md:text-[38px] leading-[1.18] tracking-tight text-gray-900"
          >
        ...
        >
          ...
          <motion.img
            ...
            className="relative z-10 w-full max-w-[350px] sm:max-w-[450px] md:max-w-[600px] drop-shadow-2xl sm:mt-12"
            animate={{ y: [0, -8, 0] }}

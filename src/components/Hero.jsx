...
//     <section
//       id="hero"
//       className="relative w-full overflow-hidden bg-white px-4 sm:px-20 pt-[100px] sm:pt-[130px] pb-16"
//     >
...
//         >
//           {/* Badge */}
//           <span className="inline-block w-fit mx-auto md:mx-0 px-4 py-1.5 rounded-full border border-[#E8ECFF] bg-[#F5F7FF] text-xs sm:text-sm font-medium text-[#15256E]">
//             Industry-Ready IT Certifications
//           </span>

//           {/* Heading (UNCHANGED TEXT) */}
//           <h1 className="font-bold text-[22px] sm:text-2xl md:text-[42px] leading-snug md:leading-tight text-black">
//             Techpro Institute Master class for Certified Scrum Master (CSM) &{" "}
//             <span className="text-[#15256E] block sm:inline">
//               {text}
//               <span className="animate-pulse">|</span>
...
//             className="flex justify-center md:justify-start"
//           >
//             <button className="mt-4 px-7 py-3.5 md:px-9 md:py-4 bg-[#15256E] text-white text-sm sm:text-base font-semibold rounded-xl shadow-md hover:shadow-xl transition">
//               Start Free Trial
//             </button>
//           </motion.div>
//         </motion.div>
...
//             src={Manage}
//             alt="Hero Illustration"
//             className="w-full max-w-[360px] sm:max-w-[480px] md:max-w-[620px] drop-shadow-xl"
//             animate={{ y: [0, -8, 0] }}
//             transition={{
//               duration: 3,
//               repeat: Infinity,
